...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (($noErr == '') && ($nameErr == '') && ($majorErr == '') && ($birthdateErr == '') && ($telephoneErr == '') && ($emailErr == '')) {
        //判断学号是否重复
        $sql = "select * from student where stu_no=$stu_no";
...
>
    <div id="content">
        <div id="left">
            <p><label>学号</label><span><input type="text" name="stu_no"/></span><span
                        class='error'>*<?php echo $noErr; ?></span></p>
            <p><label>姓名</label><span><input type="text" name="stu_name"/></span><span
            ...
            <p><label>性别</label><span>
                男<input name="gender" type="radio" value="男" checked/>
                女<input name="gender" type="radio" value="女"/></span></p>
            <p><label>生日</label><span><input type="date" name="birthdate"/></span><span
                        class="error"><?php echo $birthdateErr; ?></span></P>
            <p><label>电话</label><span><input type="text" name="telephone"/></span><span
                        class="error"><?php echo $telephoneErr; ?></span></p>
            <p><label>邮箱</label><span><input type="text" name="email"/></span><span
        ...
        <div id="bottom">
            <p>个人简介
                <script id="container" name="resume" type="text/plain"></script>
            </p>
            <p>
